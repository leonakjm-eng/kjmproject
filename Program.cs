...
namespace FishTankGame
{
    ...
    public class GameForm : Form
    {
        ...
        public GameForm()
        {
            this.Text = "Fish Tank Game - Falling Food";
            ...
            foodTimer = new Timer();
            foodTimer.Interval = 2000; // Updated to 2 seconds
        ...
        private void AddFood(object sender, EventArgs e)
        {
            ...
            {
                // Overflow: Create falling food
                Random r = new Random();
                float dropX = r.Next(fishTankRect.Left, fishTankRect.Right - 20);
                fallingFoods.Add(new FallingFood { X = dropX, Y = fishTankRect.Top });
            }
            Invalidate();
        }
