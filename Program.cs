...
namespace FishTankGame
{
    ...
    public class Fish
    {
        ...
        public void Draw(Graphics g)
        {
            ...
            // "Slow" Text removed as requested
        }
    ...
    public class GameForm : Form
    {
        ...
        public GameForm()
        {
            this.Text = "Fish Tank Game - Physics & UI";
            ...
            // UI Controls
            btnAuto = new Button { Text = "Auto Play", Location = new Point(WindowWidth - 180, WindowHeight - 40), Size = new Size(80, 30), BackColor = Color.White };
            btnAuto.Click += (s, e) => {
            ...
            btnRetry = new Button { Text = "Retry", Location = new Point(WindowWidth - 90, WindowHeight - 40), Size = new Size(80, 30), BackColor = Color.White };
            btnRetry.Click += (s, e) => { StartLevel(1); }; // Reset to Level 1
        ...
        private void HandlePhysicsAndPredation()
        {
                ...
                for (int j = i + 1; j < fishes.Count; j++)
                {
                    ...
                    if (distSq < minDist * minDist)
                    {
                        ...
                        if (!eaten)
                        {
                            ...
                            // Velocity Bounce (Elastic Collision approximation)
            ...
            if (deathCount >= 5)
            {
                ...
                // Retry resets via button, so we can just leave it or auto-retry? Prompt says "Stop game".
            }
        }
