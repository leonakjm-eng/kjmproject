...
namespace FishTankGame
{
    ...
    public class GameForm : Form
    {
        ...
        public GameForm()
        {
            this.Text = "Fish Tank Game - Balanced";
        ...
        {
            // Simplified Formula: 6 + (Level-1) * 1
        ...
        private void AddFood(object sender, EventArgs e)
        {
            ...
            {
                // Overflow Logic
                // If Level <= 5, Do not spawn falling food. Stop generation.
                // If Level > 5, Spawn falling food.
                if (currentLevel > 5)
                {
