...
namespace FishTankGame
{
    ...
    public class Fish
    {
        ...
        public List<Color> SkinLayers { get; set; }
    ...
    public class GameForm : Form
    {
        ...
        public GameForm()
        {
            this.Text = "Fish Tank Game - Redemption";
        ...
        private void RestartGame()
        {
            ...
            fallingFoods.Clear();
            foodStorage.Clear();
            deathCount = 0; // Reset deaths on retry
            isAutoPlay = false;
        ...
        {
            // Cap at 18
            return Math.Min(18, 6 + (currentLevel - 1));
        }
        ...
        private void StartLevel(int level)
        {
            ...
            // Death Redemption: Reduce death count if surviving level
            ...
            fallingFoods.Clear();
            foodStorage.Clear();
            // Note: deathCount is NOT reset here (accumulates)

            // Speed Scaling
            // Logic: Level 1-13 (Target < 18) -> Speed 1.0
            // Level 14+ (Target 18) -> Speed Increases
            float speedMult = 1.0f;
            if (level > 13)
            {
                // Increase speed after reaching cap
                speedMult = 1.0f + (level - 13) * 0.1f;
            }
            speedMult = Math.Min(3.0f, speedMult);
        ...
        private void TriggerGameClear()
        {
            ...
            trophies.Add(data);
            if (trophies.Count > 10) trophies.RemoveAt(0);
            SaveData();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Font font = new Font("Arial", 16, FontStyle.Bold))
            {
                ...
                g.DrawString($"Best: {highScore}", new Font("Arial", 10), Brushes.Green, 300, 20);

                string deathText = $"Death: {deathCount}";
                SizeF deathSize = g.MeasureString(deathText, font);
                g.DrawString(deathText, font, Brushes.Red, WindowWidth - deathSize.Width - 10, 20);
            }
